<template>
    <app-layout >
        <section>
            <v-img
                src="/src/images/header/contacto.jpg"
        ...
        <v-container class="my-12">
            <v-row>
                <v-col cols="12" md="6">
                    <h3
                        class="text-uppercase primary--text title font-weight-bold mb-3 text-left"
                    >
                ...
                <v-col cols="12" md="6">
                    <h3
                        class="text-uppercase title primary--text  font-weight-bold mb-3 text-left"
                    >
